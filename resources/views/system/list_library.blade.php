            ...
            <table class="rtable">
                ...
                <tbody>
                    ...
                    <tr data-id="{{$item['id']}}">
                        ...
                        <td class="" >{{$item['id']}}</td>
                        <td class="row_data section" data-colum="section" val="{{$item['library_section']}}" contenteditable>{{$item['library_section']}}</td>
                        <td class="row_data value" data-colum="value"   val="{{$item['library_value']}}" contenteditable>{{$item['library_value']}}</td>
