...
function storge_json($$this,update_date,del_date,isclick){
    ...
    //add id in object
    $.extend(obj[id], {id:id,gender:gender,update_date:update_date,del_date:del_date,userId:userId}); 
}
    ...
    $.ajax({
        ...
        success: function (res) {
            switch (res['status']) {
                case OK:
                    let data = res['data'];
                    $val =data.doctor_gender;
                    $('#id').val(data.doctor_id);
                    $('#name').val(data.doctor_nm);
                    $('#date_birth').val(data.doctor_birthday);
                    $('#address').val(data.doctor_address);
                    $('.option_'+$val).attr('selected','true');
                    $('#phone').val(data.doctor_phone);
                    $('#email').val(data.doctor_email);
                    $('#btn-add').hide();
                    $('#btn-edit').show();
                    break;
                case EX:
